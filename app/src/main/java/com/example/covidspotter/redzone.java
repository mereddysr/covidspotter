...
String val;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_redzone);

        val= getIntent().getExtras().get("Zone").toString();
    ...
    private class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            ListAdapter adapter = new SimpleAdapter(getApplicationContext(), contactList,R.layout.listitem, new String[]{ "dis","stat"},
                    new int[]{R.id.dist, R.id.stats});
